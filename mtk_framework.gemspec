...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<active_interaction>.freeze, ["~> 5.2"])
    s.add_runtime_dependency(%q<grape>.freeze, ["~> 1.7"])
    s.add_runtime_dependency(%q<rails>.freeze, ["~> 7.0.4", ">= 7.0.4.3"])
    s.add_runtime_dependency(%q<rspec-rails>.freeze, ["~> 6.0"])
    ...
    s.add_dependency(%q<active_interaction>.freeze, ["~> 5.2"])
    s.add_dependency(%q<grape>.freeze, ["~> 1.7"])
    s.add_dependency(%q<rails>.freeze, ["~> 7.0.4", ">= 7.0.4.3"])
    s.add_dependency(%q<rspec-rails>.freeze, ["~> 6.0"])
