...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<active_interaction>.freeze, ["~> 4.1"])
    s.add_runtime_dependency(%q<grape>.freeze, ["~> 1.3.0"])
    s.add_runtime_dependency(%q<rails>.freeze, ["~> 7.0.0"])
    s.add_runtime_dependency(%q<rspec-rails>.freeze, ["~> 3.8"])
    s.add_runtime_dependency(%q<tezos_client>.freeze)
    ...
    s.add_dependency(%q<active_interaction>.freeze, ["~> 4.1"])
    s.add_dependency(%q<grape>.freeze, ["~> 1.3.0"])
    s.add_dependency(%q<rails>.freeze, ["~> 7.0.0"])
    s.add_dependency(%q<rspec-rails>.freeze, ["~> 3.8.2"])
    s.add_dependency(%q<tezos_client>.freeze)
